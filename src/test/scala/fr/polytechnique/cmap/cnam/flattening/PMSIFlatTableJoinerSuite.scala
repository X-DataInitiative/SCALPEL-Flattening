...
import fr.polytechnique.cmap.cnam.flattening.join.PMSIFlatTableJoiner

class PMSIFlatTableJoinerSuite extends SharedContext {
  ...
  "writeAsParquet" should "flatten MCO and write it in the correct path" in {
    ...
    val flattenedTableTest = new PMSIFlatTableJoiner(sqlContext, configTest)
